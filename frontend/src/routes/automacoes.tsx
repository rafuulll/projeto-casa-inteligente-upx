        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-1.5">
              <Label>Nome</Label>
              <Input placeholder="Ex: Ligar ar quando calor" value={form.nome} onChange={(e) => setForm((f) => ({ ...f, nome: e.target.value }))} />
            </div>
            <div className="space-y-1.5">
              <Label>Descrição / Ação</Label>
              <Input placeholder="Ex: Liga o ar condicionado" value={form.descricao} onChange={(e) => setForm((f) => ({ ...f, descricao: e.target.value }))} />
            </div>
            <div className="space-y-1.5">
              <Label>Condição (trigger)</Label>
              <Input placeholder="Ex: temp > 30  |  umidade > 80  |  movimento" value={form.trigger} onChange={(e) => setForm((f) => ({ ...f, trigger: e.target.value }))} />
            </div>
          </div>
          <DialogFooter>
